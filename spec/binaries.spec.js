...
describe("decode()", () => {
  ...
  it("Should return '77338855'when passed a string of '001111001111011101110001100000011000001101001101'", () => {
    expect(decode("001111001111011101110001100000011000001101001101")).to.equal(
      "77338855"
    );
  });
